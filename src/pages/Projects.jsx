...
const Projects = () => {
  let techObj = {}
    ...
    techObj.React = <img className="techIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original-wordmark.svg" title="React" alt="React"/>
    ...
    techObj.GitHub = <svg className="techIcon" viewBox="0 0 128 128"> <title>GitHub</title> <g fill="white">
    ...
    techObj.Python = <img className="techIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-plain-wordmark.svg" title="Python" alt="Python"/>
    ...
    techObj.PostgreSQL = <img className="techIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-plain-wordmark.svg" title="PostgreSQL" alt="PostgreSQL"/>
    ...
    techObj.Firebase = <img className="techIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain-wordmark.svg" title="Google Firebase" alt="Google Firebase"/>
